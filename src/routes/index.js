...
const seoEventRoutes = require("./seoEventRoutes");
...
const seoLandingRoutes = require("./seoLandingRoutes");
...
router.use("/seo-events", seoEventRoutes);
...
router.use("/seo-landings", seoLandingRoutes);
