...
router.get("/:id/location", requireAuth, asyncHandler(getCustomerBookingLocation));
...
router.patch("/:id/assign", requireAuth, requireRole("super_admin", "vendor_admin"), asyncHandler(assignBookingResources));
