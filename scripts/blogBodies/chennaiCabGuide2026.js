...
/** HTML body for Chennai cab & driver SEO guide (rendered on /blog/...). */
module.exports = `
...
<ol>
  <li><strong>Enter pickup &amp; drop</strong> — city locality, airport terminal, or outstation destination.</li>
  <li><strong>Login with mobile OTP</strong> — secure 10-digit verification, no password needed.</li>
  <li><strong>Choose vehicle &amp; package</strong> — local 4hr/8hr, outstation one way or round trip; compare prices.</li>
  <li><strong>Confirm &amp; travel</strong> — driver contact shared by SMS/WhatsApp before pickup.</li>
</ol>
...
<ul>
  <li><strong>Local taxi</strong> — point-to-point or hourly packages inside Chennai.</li>
...
<p>Compare one way vs round trip before you confirm — round trip works if you need the same cab to wait or return the same day. See fixed route fares on <a href="https://cabzii.in/routes/chennai-to-tirupati-cab">Chennai to Tirupati cab</a> or search packages on <a href="https://cabzii.in/holidays">holiday tours</a>.</p>

<h2>Vehicle guide — which cab to pick?</h2>
<table>
  <thead><tr><th>Vehicle</th><th>Best for</th><th>Typical use</th></tr></thead>
  <tbody>
    <tr><td>Maruti Dzire</td><td>Couples, 3–4 passengers</td><td>Airport, city, short outstation</td></tr>
    <tr><td>Maruti Ertiga</td><td>Small families</td><td>Weekend trips, Tirupati</td></tr>
    <tr><td>Toyota Innova</td><td>Comfort, 6–7 seats</td><td>Long highway routes</td></tr>
    <tr><td>Tempo Traveller</td><td>Groups 10–12</td><td>Pilgrimage, weddings</td></tr>
  </tbody>
</table>

<h2>Fares &amp; what is included</h2>
<p>Cabzii shows <strong>package fare upfront</strong> — local slabs (4hr/40km, 8hr/80km), outstation one way minimum km, and round trip day rates. Extra km and extra hour charges are listed on each card. Toll, permit and driver bata for outstation trips may apply as per vendor policy and are shown before payment.</p>

<h2>Why book on Cabzii instead of random call centres?</h2>
<ul>
  <li>Compare multiple vendors in one search</li>
  <li>OTP-secured booking &amp; trip history</li>
  <li>Acting driver + full cab in one account</li>
  <li>Holiday packages with vehicle upgrade options</li>
  <li>Support on WhatsApp for changes</li>
</ul>
